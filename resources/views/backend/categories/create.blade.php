                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <ol class="breadcrumb pull-right">
                            ...
                            <li class="breadcrumb-item active">اضافة التصنيف</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('store.categories.main') }}" method="POST" class="needs-validation" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group row">
                                    <label for="category" class="col-xl-3 col-sm-4 mb-0">التصنيف<span>*</span> :</label>
                                ...
                                <div class="form-group row">
                                    <label for="subcategory" class="col-xl-3 col-sm-4 mb-0">تصنيف الفرعي<span>*</span> :</label>
                                    <div class="col-xl-8 col-sm-7">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <textarea class="form-control" id="myTextarea"  name="descr"></textarea>
                                    </div>
                                </div>
