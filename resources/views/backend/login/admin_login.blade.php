...
<head>
    ...
    <link rel="icon" href="{{ url('../public/logo/logo.jpg') }}">
    <!--Page title-->
    ...
    <!--Custom CSS-->
    <link rel="stylesheet" href="{{ url('../public/css') }}/style-login-register.css">
</head>
                                    ...
                                    <div class="card-front">
                                        <div class="center-wrap" dir="rtl">
                                            <div class="section text-center">
                                                ...
                                                <form action="{{route('admin.login')}}" method="post" dir="ltr">
                                                    @csrf
                                                    <div class="form-group">
                                                        <input type="email" name="email" class="form-style"
                                                            placeholder="email" id="logemail" autocomplete="on">
                                                        <i class="input-icon uil uil-at"></i>
                                                    </div>
                                                    <div class="form-group mt-2">
                                                        <input type="password" name="password" class="form-style"
                                                            placeholder="Password" id="logpass"
                                                            autocomplete="off">
                                    ...
                                    <div class="card-back">
                                        <div class="center-wrap" dir="rtl">
                                            <div class="section text-center">
                                                ...
                                                <form action="{{route('admin.register.create')}}" method="post" dir="ltr">
                                                    @csrf
                                                    <div class="form-group">
                                                        <input type="text" name="name" class="form-style"
                                                            placeholder="Enter your full name" id="logname"
                                                            autocomplete="off">
                                                    ...
                                                    <div class="form-group mt-2">
                                                        <input type="password" name="password_confirmation" class="form-style"
                                                            placeholder="Confirm Password" id="logpass"
                                                            autocomplete="off">
                                                        <i class="input-icon uil uil-lock-alt"></i>
                                                    </div>
